...
def main():
    ...
    with open('../data_training_psd_de.npy', 'rb') as fileTrain:
        X_train = np.load(fileTrain)
        
    with open('../label_training_psd_de.npy', 'rb') as fileTrainL:
    ...
    with open('../data_testing_psd_de.npy', 'rb') as fileTest:
        X_test = np.load(fileTest)
        
    with open('../label_testing_psd_de.npy', 'rb') as fileTestL:
    ...
    plt.plot(history_valence.history['loss'], label='Training Loss')
    plt.plot(history_valence.history['val_loss'], label='Validation Loss')
    plt.title('CNN Loss Curve - Binary Classification Valence (PSD-DE)')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.legend()
    plt.show()
